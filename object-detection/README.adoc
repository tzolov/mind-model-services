...
|===
| image:{docdir}/src/docs/asciidoc/images/object_detection_1.jpg[alt=Object Detection 1, width=100%]
...
image:{docdir}/object-detection/src/test/resources/doc/object-detection-segmentation-augmented.jpg[alt=Object Detection Augmented, width=60%]
